...
export class EstudiantesService {
    ...
    getEstudiantePorID(idEstudiante: number) {
        return this.httpClient.get<Estudiante>(Endpoints.getEstudiantePorID.replace(':id', idEstudiante.toString()));
    }
    ...
    updateEstudiante(idEstudiante: number, estudiante: Estudiante) {
        ...
        return this.httpClient.patch<number>(Endpoints.updateEstudiante.replace(':id', idEstudiante.toString()), body);
    }
}